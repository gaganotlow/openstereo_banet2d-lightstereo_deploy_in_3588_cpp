...
# onnx model path
onnx_model_path = '/workspace/models/lightstereo_s_orin_epoch199_best_val_epe_480x640.onnx'
# quant data
DATASET_PATH = '/workspace/test_data/quant_data/dataset.txt'
# output paths
DEFAULT_RKNN_PATH = '/workspace/models/lightstereo_s_orin_epoch199_best_val_epe_480x640.rknn'
